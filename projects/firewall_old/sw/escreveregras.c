...
void dumpCounts()
{
  ...
  writeReg(&nf2, SRAM_BASE_ADDR, NUM_PORTA);
  writeReg(&nf2, SRAM_BASE_ADDR+4, NUM_PORTA+1);
  writeReg(&nf2, SRAM_BASE_ADDR+8, NUM_PORTA+2);
  writeReg(&nf2, SRAM_BASE_ADDR+12, NUM_PORTA+3);
